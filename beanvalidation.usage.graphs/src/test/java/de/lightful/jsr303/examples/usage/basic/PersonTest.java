...
public class PersonTest {
  ...
  public void validationFailsForIncomeBelow2000() {
    ...
    Income petersIncome = new Income(1999);
    peter.addIncome(petersIncome);
    ...
    log.info("Leaf Bean" + violation.getLeafBean());

    log.info("Peter: " + peter);
    log.info("Root Bean: " + violation.getRootBean());
    assertThat(violation.getRootBean()).as("Root Bean").isSameAs(peter);

    log.info("Peter's income: " + petersIncome);
    log.info("Leaf Bean: " + violation.getLeafBean());
    assertThat(violation.getLeafBean()).as("Leaf Bean").isSameAs(petersIncome);
  }
}
